            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Number of Products Supplied by a Company</h4>
                            </div>
                            <div class="content">
                            <canvas id="chart04"></canvas>
                            <?php
                                $query04= "SELECT suppliers.CompanyName AS 'Supplier', COUNT(products.ProductName) AS 'Number of Products' FROM northwind.suppliers, northwind.products WHERE suppliers.SupplierID = products.SupplierID GROUP BY suppliers.SupplierID";
...
label: 'Price',
data: Count_Order,
backgroundColor: [ '#29485B', '#336296', '#2093C3', '#8ACBDE', '#C0E6F0' ],
hoverOffset: 4
}]
};
// <!-- config block -->
...
data: Count_Order02,
backgroundColor: [ '#FC6A03', '#EC9706', '#8D4004', '#D16002', '#FDA172', '#DD571C', '#CC5801', '#FCAE1E', '#B56727' ],
hoverOffset: 4
}]
};
// <!-- config block -->
...
datasets: [{
label: 'Country with more than 15 orders',
data: Count_Order03,
backgroundColor: [ '#9866C7', '#311465', '#957A81', '#9E7BB3', '#4DOF28', '#29021A', '#601A3E', '#873260', '#A50B5E', '#4C0212', '#AF69ED', '#D34DD2', '#B47EE5'],
hoverOffset: 4
}]
};
// <!-- config block -->
...
datasets: [{
label: 'Number of Products supplied by a Company',
data: Count_Order04,
backgroundColor: [ '#FFB5E8', '#B28DFF', '#AFF8DB', '#6EB5FF', '#FFF5BA'],
hoverOffset: 4
}]
};
// <!-- config block -->
